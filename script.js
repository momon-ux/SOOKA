...
const rumusanKategori = {
    ...
    triangulasi_hem: "Berdasarkan triangulasi Pengurusan HEM, prasarana hal ehwal murid (A6) kekal pada 10% untuk kedua-dua tahun, manakala pengurusan hal ehwal murid (Standard 3.3) meningkat secara signifikan daripada 86.94% pada tahun 2024 kepada 92.07% pada tahun 2025, menunjukkan penambahbaikan dalam struktur dan pelaksanaan hal ehwal murid. Selain itu, kemenjadian sahsiah murid (Standard 5.3) juga mencatat kenaikan sedikit daripada 16.09% kepada 16.56%, yang mencerminkan peningkatan dalam aspek pembangunan sahsiah pelajar walaupun pada kadar yang lebih perlahan. Secara keseluruhan, data ini menunjukkan bahawa usaha meningkatkan pengurusan hal ehwal murid telah membuahkan hasil, terutamanya dari segi organisasi dan pelaksanaan program, walaupun prasarana fizikal masih tidak berubah."
};
